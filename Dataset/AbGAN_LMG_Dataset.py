...
class AbGAN_Dataset(Dataset):
    def __init__(self,sequences,label_path,max_len,model_select,device,num):
        self.sequence = self.Seq_Padding_OneHot(sequences,max_len,num)
    ...
    def Seq_Padding_OneHot(self,sequence,max_lens,num):
        data_seq_list=[]
    ...
    def AntiBERTSS_Label(self,sequence,device,model_select,num):
